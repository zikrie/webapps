...
class NoticeDeathController extends CommonController
{
    ...
    public function index()
    {
        ...
        return view('noticedeath.index',['obprofile'=>$obprofile,'state'=>$state, 'branch'=>$branch,
    ...
    public function Preview()
    {
        ...
        return view('noticedeath.preview',['obprofile'=>$obprofile,'state'=>$state,'branch'=>$branch, 
            'idtype'=>$idtype, 'race'=>$race, 'national'=>$national, 'mcsts'=>$mcsts, 'transport'=>$transport,
