...
class ReemploymentController extends Controller
{
    ...
    public function index_PK()
    {
        ...
        return view('scheme.noticeInvalidity.Revision.Reemployment.PK.index',['idtype'=>$idtype,'doclist'=>$doclist,'docinfo'=>$docinfo,'doclist_select'=>$alldoclist, 'month' => $month]);
    }
