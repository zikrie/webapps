...
class BGRController extends Controller
{
    ...
    {
        return view('scheme.noticeAccident.others.BGR.IO.index');
    }

    public function index_SCO()
    {
        return view('scheme.noticeAccident.others.BGR.SCO.index');
    }

    public function index_SAO()
    {
        return view('scheme.noticeAccident.others.BGR.SAO.index');
    }
}
