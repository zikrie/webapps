  ...
  function () {
    ...
    _createClass(Calendar, [{
      ...
      value: function _renderHeader() {
        ...
        //CHANGE 25/07/2019
        //CHANGE prev2YearDiv.classList.add('disabled'); TO prevDiv.classList.add('disabled');
        ...
        //CHANGE 25/07/2019
        //CHANGE new Date(this.options.startYear + 1, 0, 1) TO new Date(this.options.startYear + 2, 0, 1)
      ...
      value: function _openContextMenu(elt) {
        ...
        //add 11/07/2019 (not from template)
        // var eventSubmenu = document.createElement('div');
        // eventSubmenu.classList.add('item');
        // var eventSubmenuContent = document.createElement('div');
        // eventSubmenuContent.classList.add('content');
        // eventSubmenuContent.textContent = 'Meeting';
        // eventSubmenu.appendChild(eventSubmenuContent);
        // var icon = document.createElement('span');
        // icon.innerHTML = "&rsaquo;";
        // eventSubmenu.appendChild(icon);
        ...
        for (var i = 0; i < events.length; i++) {
          ...
          //add 11/07/2019 (not from template)
          // contextMenu.appendChild(eventSubmenu);
          
          //add 11/07/2019 (not from template)
          // contextMenu.appendChild(subMenu);
          // contextMenu.appendChild(eventSubmenu);
          // subMenu.appendChild(eventItem);

          //add 11/07/2019 (not from template)
          // eventSubmenu.appendChild(subMenu);
