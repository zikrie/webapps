        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="custom-control custom-radio">
                    ...
                    <label class="custom-control-label" for="type_of_account1">@lang('confirmation.attr.saving')</label>
                </div>
                <div class="custom-control custom-radio">
                    <input type="radio" name="type_of_account" id="type_of_account2" value="Current"
                        class="custom-control-input">
                    <label class="custom-control-label" for="type_of_account2">@lang('confirmation.attr.current')</label>
                </div>
            </div>
        </div>
    </div>
