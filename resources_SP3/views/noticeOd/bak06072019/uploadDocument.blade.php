                    ...
                    <div class="form-body">
                        ...
                        <div class="form-actions">
                                    ...
                                    <table class="table" id="table_upload_doc">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href='/viewdoc?docname={{$d->docname}}' target="_blank">View</a></td>
                                                <?php $docfound = true;?>
                                                @break
                                                @endif
                                                @endforeach
                            ...
                            <div class="form-action">
                                <button type="submit" class="btn btn-success">@lang('uploaddoc.uploadall')</button>
                                    <button type="button" id="add_doc"
                                        class="btn btn-success">@lang('uploaddoc.adddoc')</button>
                                    <!--button type="submit"
