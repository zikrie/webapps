...
<div class="col-12">
    <div class="card card-body">
        <h4 class="card-title">@lang('home.task')</h4>
                        ...
                        <div class="card-body" style="background-color: #d8e8e9;">
                            <div class="d-flex flex-row">
                                ...
                                <div class="m-l-10 align-self-center">
                                    ...
                                    <h5 class="text-muted m-b-0">@lang('home.draft')</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body" style="background-color: #d8e8e9;">
                            <div class="d-flex flex-row">
                                ...
                                <div class="m-l-10 align-self-center">
                                    <h3 class="m-b-0">0</h3>
                                    <h5 class="text-muted m-b-0">@lang('home.query')</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="tblwb" class="table table-sm table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('home.noticetype')</th>
                                <th style='display: none'>@lang('home.caserefno')</th>
                                <th style='display: none'>noticetype</th>
                                <th>@lang('home.idno')</th>
