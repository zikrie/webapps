...
$(document).ready(function() {
    ...
    $('#btn_add_ot').click(function(){  
        ...
        html += '<div class="card m-b-0"><div class="card-header" role="tab" id="otinfo"><h6 class="card-subtitle"><a class="collapsed link" data-toggle="collapse" data-parent="#ot_accordion'+i+'" href="#ot_collapse'+i+'" aria-expanded="false" aria-controls="collapseTwo2">@lang('dependantsProfile.title')</a></h6></div>';
        ...
        html += '<label class="control-label">@lang('dependantsProfile.attr.ot_name')</label><input type="text" id="name" name="name[]" value="" class="form-control"></div></div></div>';
        ...
        html += '<div class="col-md-3"><div class="form-group"><label class="control-label">@lang('dependantsProfile.attr.id_no')</label><input type="text" id="idno" name="idno[]" value="" class="form-control"> </div></div></div>';
        ...
        html += '<div class="row"><div class="col-md-3 date_birth" id="date_birth'+i+'"><div class="form-group"><label class="control-label">@lang('dependantsProfile.attr.dateOfBirth')</label><input type="date" id="dob" name="dob[]" value="" class="form-control date_birth"></div></div>';
        ...
        html += '<div class="row"><div class="col-md-4 married_date_box" id="married_date'+i+'"><div class="form-group"><label class="control-label">@lang('dependantsProfile.attr.married_date')</label><input type="date" id="marrieddate" name="marrieddate[]" value="" class="form-control"></div></div>';
        html += '<div class="col-md-3 registered_married_box" id="registered_married'+i+'"><div class="form-group"><label class="control-label">@lang('dependantsProfile.attr.registered_married')</label><select class="form-control" name="regmarried[]"><option>Please select</option><option value="Y">@lang('dependantsProfile.attr.yes')</option><option value="N">@lang('dependantsProfile.attr.no')</option></select></div></div></div>';
        ...
        html += '<div class="col-md-6"><div class="form-group"><label class="control-label">@lang('dependantStudy.attr.pls_specify')</label><input type="text" name="eduothers[]" id="eduothers" class="form-control"></div></div></div>';
        ...
        $('select[id=ots]').on('change', function () {
