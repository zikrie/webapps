                                    ...
                                    <div class="card">
                                        ...
                                        <div class="table-responsive">
                                            <table id="demo-foo-row-toggler" class="table table-bordered" data-toggle-column="first">
                                                ...
                                                @while ($cnt < 6)   
                                                <?php 
                                                $ilatmonth = $ilatmonth - 1;
                                                if ($ilatmonth <= 0)
                                                {
                                                    $ilatmonth = 12 + $ilatmonth;
                                                    $ilatyear  = $ilatyear - 1;
                                                }
                                                ?>
                                                    <tr data-expanded="true">
                                                        ...
                                                        <td><input type="text" id="year[{{$contrcnt}}][{{$cnt}}]" name="year[{{$contrcnt}}][{{$cnt}}]" value="{{$ilatyear}}" class="form-control" readonly></td>
                                                        ...
                                                        @foreach ($wagesinfo as $w)
                                                            ...
                                                            @foreach ($w->wagesinfo as $gaji)
                                                                @if ($gaji->month == $ilatmonth && $gaji->year == $ilatyear)
                                                        ...
                                                        @if ($c->month == $ilatmonth && $c->year == $ilatyear)
