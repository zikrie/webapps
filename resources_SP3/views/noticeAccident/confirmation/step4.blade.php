        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control custom-select">
                    <option selected disabled hidden>@lang('confirmation.choose4')
                    </option>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="custom-control custom-radio">
                    ...
                    <label class="custom-control-label" for="overseas_bank_type_of_account1">Saving</label>
                </div>
                <div class="custom-control custom-radio">
                    ...
                    <label class="custom-control-label" for="overseas_bank_type_of_account2">Current</label>
                </div>
            </div>
        </div>
    </div>
