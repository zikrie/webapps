...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="PERKESO_UI/assets/images/icon-perkeso.png">
...
<body>
    ...
    <!-- ============================================================== -->
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(PERKESO_UI/assets/images/background/page-perkeso.png);">
        <div class="login-box card">
            <div class="card-body">
                <!-- <form class="form-horizontal form-material text-center" id="loginform" action="index.html"> -->
                    <a href="javascript:void(0)" class="db"><img src="PERKESO_UI/assets/images/ICON-perkeso.png" alt="Home" /><br/><img src="../assets/images/logo-text.png" alt="Home" /></a>
