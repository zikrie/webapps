<div class="row">
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      <form method="POST" id="form_guardian" action="./guardianinfo">
                         ...
                         @endforeach 
                         @else
                              @include('noticedeath.guardianDetails_add')
                         @endif
                              <div id='container_g'>
     ...
     {{-- Confirm modal --}}
     <div class="modal fade" id="deletemodal_g" tabindex="-1" role="dialog" aria-hidden="true">
     ...
     <div class="modal-content">
          ...
          <button type="button" id="btn_close2" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button>
          <button type="button" id="btn_delete2" class="btn btn-danger btn-sm" data-dismiss="modal">Delete</button>
          </div>
     </div>
     </div>
     </div>
     ...
     $( document ).ready(function() {
        ...
        // check_unchecked();
         ...
         $('#btn_add_guardian').click(function(){  
          ...
          var display = $('table[id^="tableOT"]').find('tbody > tr:not([style*="display: none"])').length;
          ...
          // alert(checked);
           ...
           var no = i + 1;
             html = '<div class="row" id="guardian_list"><div class="col-md-12"><div id="guardian_accordion'+i+'" role="tablist" aria-multiselectable="true">';    
             html += '<div class="card m-b-0"><div class="card-header" role="tab" id="guardianinfo'+i+'"><h6 class="card-subtitle"><a class="collapsed link" data-toggle="collapse" data-parent="#guardian_accordion'+i+'" href="#guardian_collapse'+i+'" aria-expanded="false" aria-controls="collapseTwo'+i+'">@lang('guardianDetails.title') </a><button type="button" id="btn_del_g'+i+'" class="close btn_del_g" aria-label="Close"><span aria-hidden="true">&times;</span></button></h6></div>';
         ...
         $('#container_g').on('click','.btn_del_g',function(){
               var delete_id = $(this).attr('id');
               //alert(delete_id);
               $('#deletemodal_g').modal('show');
               $("#deletemodal_g .modal-footer button").on('click', function(e) {
                    var btn_id = e.target.id;
                    if(btn_id == 'btn_delete2'){
                         //alert("masuk");
                    $("#"+delete_id).closest("#guardian_list").empty();
                    }
