            ...
            <div class="card-body">
                <form method="POST" action="/applicantinfo">
                    ...
                    <div class="form-body">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.name')</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.relationship')</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.id_type')</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.id_no')</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.address')</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.postcode')</label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.state')</label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.city')</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.telNo')</label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.mobileNo')</label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.email')</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.pobox')</label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.lockedbag')</label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.wdt')</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4" id="div_amount{{ $key }}">
                                                        <div class="form-group">
                                                            <label
                                                                class="control-label">@lang('applicantDetails.attr.amount')</label>
                        ...
                        @else
                        @include('noticedeath.applicantDetails_add')
                        @endif
                    </div>
                    ...
                    <div class="form-actions text-right">
                        ...
                        <button type="button" id="btn_add_applicant"
                            class="btn btn-sm waves-effect waves-light btn-info">ADD APPLICANT</button>
                        <br><br>
                    </div>
                    ...
                    '<div id="applicant_accordion'+i+'" role="tablist" aria-multiselectable="true">'+
                        '<div class="card m-b-0">'+
                            '<div class="card m-b-0">'+
                                '<div class="card-header" role="tab" id="applicantinfo">'+
                                    '<h6 class="card-subtitle">'+
                                        '<a class="collapsed link" data-toggle="collapse" data-parent="#applicant_accordion'+i+'" href="#applicant_collapse'+i+'" aria-expanded="false" aria-controls="collapseTwo2">@lang('applicantDetails.title') </a>'+
