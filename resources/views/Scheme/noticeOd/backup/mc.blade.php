<div class="col-lg-12">
    ...
    <div class="card-body">
        <form method="post" action="{{url ('/odupdmc')}}">
                ...
                <div class="col-md-12" id="container">
                    <div class="table-responsive" id="table-medical">
                        <div class="form-actions text-right">
                            <button type="button" id="btn_add_mc0" value='0' class="btn btn-sm waves-effect waves-light btn-info">@lang('scheme/medicalDetails.attr.addMc')</button>
            ...
            <div class="form-actions text-right">
                <button type="submit" class="btn btn-sm waves-effect waves-light btn-success btn-newMC" id='btnsubmit' onclick="mcsubmit()">@lang('scheme/insuredPerson.save')</button>
                <button type="button" id="btn_add_clinic" class="btn btn-sm waves-effect waves-light btn-info">@lang('scheme/medicalDetails.attr.addClinic')</button>
    ...
    $(document).ready(function() {
        ...
        $('#btn_add_clinic').click(function(){
            ...
            "<div class='col-md-12' id='container'>"+
                ...
                "<div class='table-responsive   ' id='table-medical'>"+
                        "<div class='form-actions text-right'>"+
                        "<button type='button' id='btn_add_mc"+i+"'value='"+i+"' class='btn btn-sm waves-effect waves-light btn-info'>@lang('scheme/medicalDetails.addMc')</button>"+
                        "</div>"+
