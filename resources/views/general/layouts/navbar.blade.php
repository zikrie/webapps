...
<div class="scroll-sidebar">
    ...
    <nav class="sidebar-nav">
        <ul id="sidebarnav">
            ...
            <li><a class="fcolor" href="/home"><i class="icon-home"></i>@lang('scheme/navbar.home')</a></li>
            <li> <a class="has-arrow fcolor" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">@lang('scheme/navbar.new_claim')</span></a>
                <ul aria-expanded="false" class="collapse">
                   <li><a href="/Scheme">@lang('scheme/navbar.new_claim')</a></li>
