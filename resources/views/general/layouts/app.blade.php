                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="home">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="/PERKESO_UI/assets/images/perkeso_png.png" alt="homepage" class="light-logo" style="width:30%;height:30%;"/>
                            <!-- Light Logo icon -->
                            &nbsp;&nbsp;
                            <img src="/PERKESO_UI/assets/images/logo_beams.png" alt="homepage" class="light-logo" style="width:45%;height:45%;" />
                            </b>
                        <!--End Logo icon -->
                        ...
                        {{--<div class="nav-item dropdown u-pro">
                           ...
                           {{--  <ul class="navbar-nav my-lg-0">
                            ...
                            <div class="nav-item dropdown u-pro">
                                ...
                                <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="hidden-md-down">{{Session::get('loginname')}} ,
