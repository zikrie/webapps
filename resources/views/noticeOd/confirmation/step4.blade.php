<h6>@lang('confirmation.overseas_bank')</h6>
<section>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control custom-select">
                    <option selected disabled hidden>@lang('confirmation.attr.choose_bank')
                    </option>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="custom-control custom-radio">
                    <input type="radio" name="overseas_bank_type_of_account" id="overseas_bank_type_of_account1"
                        value="Saving" class="custom-control-input">
                    <label class="custom-control-label" for="overseas_bank_type_of_account1">@lang('confirmation.attr.saving')</label>
                </div>
                <div class="custom-control custom-radio">
                    <input type="radio" name="overseas_bank_type_of_account" id="overseas_bank_type_of_account2"
                        value="Current" class="custom-control-input">
                    <label class="custom-control-label" for="overseas_bank_type_of_account2">@lang('confirmation.attr.current')</label>
                </div>
            </div>
        </div>
    </div>
