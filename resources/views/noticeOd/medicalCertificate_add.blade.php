      ...
      <div class="card m-b-0">
        <div class="card-header" role="tab" id="attendwork">
          <h6 class="card-subtitle">
            <a class="collapsed link" data-toggle="collapse" data-parent="#mc_accordion0" href="#mc_collapse0" aria-expanded="false" aria-controls="collapseTwo2">> @lang('medicalDetails.attr.medicalleave')</a>
