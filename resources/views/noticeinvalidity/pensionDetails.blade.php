                        ...
                        <div class="row p-t-12">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="year_morbidity" onchange='checkyear()' id='year_morbidity'>
                                        <option></option>
                                        <?php $curryear = date('Y'); ?>
                            ...
                            <div class="col-md-3" >
                                <div class="form-group">
                                    <label style="white-space:nowrap" class="control-label">@lang('pensionDetails.attr.engaged_employment') </label>
                                    <select name="engage" class="form-control" data-placeholder="Choose a Category" tabindex="1">
