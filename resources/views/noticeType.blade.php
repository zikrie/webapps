                            	...
                            	<div class="form-group">
                                	<label class="control-label">@lang('noticetype.attr.notice_type')</label>
                                	 <select  name="notice_type" id='notice_type' class="form-control">
                                	 	<option>@lang('noticetype.attr.please_select')</option>
                        ...
                        <div class="row">
                            <div class="col-md-4">
		                        <button type="submit" id="btnnotice" class="btn btn-success" onclick="checkmandatory()"> @lang('noticetype.next')</button>
		                       	<!-- <button type="" id="btnnotice" class="btn btn-success" onclick="checkmandatory()"> @lang('noticetype.reset')</button>
		                       	<button type="" id="btnnotice" class="btn btn-success" onclick="checkmandatory()"> @lang('noticetype.close')</button>	 -->
                            </div>
                        </div>
