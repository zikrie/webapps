                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content tabcontent-border">
                            ...
                            <div class="tab-pane p-20 active" id="remarks" role="tabpanel">
                                @include('Scheme.noticeAccident.revision.date_accident.IO.remarks')
                            </div>
                                ...
                                <div id="accordion2" role="tablist" class="accordion">
                                    ...
                                    <div class="card m-b-0">
                                        ...
                                        <div id="caseInfo" class="collapse" role="tabpanel"
                                            ...
                                            <div class="card-body">
                                                @include('Scheme.noticeAccident.revision.date_accident.IO.case_info')
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card m-b-0">
                                        ...
                                        <div id="obInfo" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                            <div class="card-body">
                                                @include('Scheme.noticeAccident.revision.date_accident.IO.ob_info')
                                            </div>
                                        </div>
                                        <div class="card m-b-0">
