                    ...
                    <form action="#">
                        <div class="form-body">
                            ...
                            <div class="row p-t-20">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control">
                                            ...
                                            <option value="">Pennyiasatan</option>
                                            ...
                                            <option value="">Pilihan Bayaran</option>
                                            <option value="">Dalam Process</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">IO Recommendation By</label>
                                        <input type="text" id="" class="form-control" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">IO Recommendation Date</label>
                                        <input type="date" id="" class="form-control" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">Scheme Approval</label>
                                        <input type="date" id="" class="form-control" >
                                    </div>
                                </div>
                            </div>
