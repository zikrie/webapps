        ...
        <div class="card-body">
            ...
            <!-- Tab panes -->
                ...
                <ul class="nav customtab" role="tablist" id="tabMenu">
                        ...
                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#recommendationsReverseDecSAO"
                ...
                <div class="tab-content tabcontent-border">
                                ...
                                <div id="accordion2" role="tablist" class="accordion">
                                        ...
                                        <div class="card m-b-0">
                                                ...
                                                <div id="statementSAO" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                                        <div class="card-body">
                                                                @include('scheme.noticeAccident.revision.reverse_decision_nationality.SAO.statement')
                                                        </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="card m-b-0">
                                                ...
                                                <div id="caseFactSAO" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                                        <div class="card-body">
                                                                @include('scheme.noticeAccident.revision.reverse_decision_nationality.SAO.caseFact')
                                                        </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="card m-b-0">
                                                ...
                                                <div id="investigationInfoSAO" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                                        <div class="card-body">
                                                                @include('scheme.noticeAccident.revision.reverse_decision_nationality.SAO.investigationReport')
                                                        </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="card m-b-0">
                                                ...
                                                <div id="inconsistentInfoSAO" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                                        <div class="card-body">
                                                                @include('scheme.noticeAccident.revision.reverse_decision_nationality.SAO.inconsistentInfo')
                                                        </div>
                                                </div>
                                        </div>
                        ...
                        <div class="tab-pane p-20" id="recommendationsReverseDecSAO" role="tabpanel">
