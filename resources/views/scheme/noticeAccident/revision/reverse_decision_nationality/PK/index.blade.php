            ...
            <!-- Tab panes -->
                ...
                <div class="tab-content tabcontent-border">
                        <div class="tab-pane p-20 active" id="remarksReverseDecPK" role="tabpanel">
                                @include('scheme.noticeAccident.revision.reverse_decision_nationality.PK.remarksPK')
                        </div>
                        <div class="tab-pane p-20" id="supportingDocumentReverseDecPK" role="tabpanel">
                                @include('scheme.noticeAccident.revision.reverse_decision_nationality.PK.supportingDocPK')
                        </div>
