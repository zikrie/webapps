    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="update_takwim_modal">@lang('medical_board/takwim.takwim')</h4>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group input-daterange" id="date-range_update">
                                    <input id="min-date" name="takwim-start-date" type="text" class="form-control start_update" readonly>
