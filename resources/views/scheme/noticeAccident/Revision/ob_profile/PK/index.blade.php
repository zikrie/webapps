                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane p-20 active" id="remarks" role="tabpanel">
                                @include('Scheme.revision.obProfile.PK.remarks')
                            </div>
                                ...
                                <div id="accordion2" role="tablist" class="accordion">
                                    ...
                                    <div class="card m-b-0">
                                        ...
                                        <div id="caseInfo" class="collapse" role="tabpanel"
                                            ...
                                            <div class="card-body">
                                                @include('Scheme.revision.OBProfile.PK.case_info')
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card m-b-0">
                                        ...
                                        <div id="obProfile" class="collapse" role="tabpanel"
                                            aria-labelledby="headingOne1">
                                            <div class="card-body">
                                                @include('Scheme.revision.OBProfile.PK.ob_info')
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card m-b-0">
                                        ...
                                        <div id="obProfile2" class="collapse" role="tabpanel"
                                            aria-labelledby="headingOne1">
                                            <div class="card-body">
                                                @include('Scheme.revision.OBProfile.PK.ob_info2')
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card m-b-0">
                                        ...
                                        <div id="declaration117" class="collapse" role="tabpanel"
                                            aria-labelledby="headingOne1">
                                            <div class="card-body">
                                                @include('Scheme.revision.OBProfile.PK.declaration117')
                                            </div>
                                        </div>
                                    </div>
