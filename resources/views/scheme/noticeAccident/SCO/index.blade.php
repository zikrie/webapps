...
{{-- <div class="col-md-12"><br> --}}
	<div class="card-body p-b-0">
		...
		<ul class="nav customtab" role="tablist">
			...
			<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#inconsistency" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">@lang('form/scheme.general.tab_title.inconsistenct_info')</span></a> </li>
		...
		<div class="tab-content">
			...
			<div class="tab-pane p-20" id="claimDetails" role="tabpanel">
				@include('scheme.noticeAccident.SCO.collapse')
			</div>
