<div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="/employerdetails_sco" method="POST" id="reset">
                            ...
                            <button type="submit" class="btn btn waves-effect waves-light btn-secondary">Search</button>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="empcode" name="empcode" value="{{$emprecord->empcode}}" class="form-control clearFields"  readonly>
                                        @elseif(!empty($employer) && $employer->empcode != '')
                                        <input type="text" id="empcode" name="empcode" value="{{$employer->empcode}}" class="form-control clearFields"  readonly>
                                        @else
                                        <input type="text" id="empcode" name="empcode" value="" class="form-control clearFields"  readonly>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="empname" name="empname" value="{{$emprecord->empname}}" class="form-control clearFields"  readonly>
                                        @elseif(!empty($employer) && $employer->empname != '')
                                        <input type="text" id="empname" name="empname" value="{{$employer->empname}}" class="form-control clearFields"  readonly>
                                        @else
                                        <input type="text" id="empname" name="empname" value="" class="form-control clearFields"  readonly>
                                        @endif
                                    </div>
                                </div>  
                                {{-- <div class="row"> --}}
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="bussentity" name="bussentity" value="{{$emprecord->bussentity}}" class="form-control">
                                                @elseif(!empty($employer) && $employer->bussentity != '')
                                                <input type="text" id="bussentity" name="bussentity" value="{{$employer->bussentity}}" class="form-control">
                                                @else
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">@lang('employerDetails.attr.subbusiness_entity')</label>
                                                @if(!empty($emprecord) && $emprecord->subbussentity != '')
                                                <input type="text" id="subbussentity" name="subbussentity" value="{{$emprecord->subbussentity}}" class="form-control">
                                                @elseif(!empty($employer) && $employer->subbussentity != '')
                                                <input type="text" id="subbussentity" name="subbussentity" value="{{$employer->subbussentity}}" class="form-control">
                                                @else
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">@lang('employerDetails.attr.subbusiness_list')</label>
                                                @if(!empty($emprecord) && $emprecord->subbussentitylist != '')
                                                <input type="text" id="subbussentitylist" name="subbussentitylist" value="{{$emprecord->subbussentitylist}}" class="form-control">
                                                @elseif(!empty($employer) && $employer->subbussentitylist != '')
                                                <input type="text" id="subbussentitylist" name="subbussentitylist" value="{{$employer->subbussentitylist}}" class="form-control">
                                                @else
                                    ...
                                    {{-- <div class="row"> --}}
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="servicetype" name="servicetype" value="{{$emprecord->servicetype}}" class="form-control">
                                                @elseif(!empty($employer) && $employer->servicetype != '')
                                                <input type="text" id="servicetype" name="servicetype" value="{{$employer->servicetype}}" class="form-control">
                                                @else
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="indscode" name="indscode" value="{{$emprecord->indscode}}" class="form-control">
                                                @elseif(!empty($employer) && $employer->indscode != '')
                                                <input type="text" id="indscode" name="indscode" value="{{$employer->indscode}}" class="form-control">
                                                @else
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">@lang('employerDetails.attr.subindustry_list')</label>
                                                @if(!empty($emprecord) && $emprecord->subindscodelist != '')
                                                <input type="text" id="subindscodelist" name="subindscodelist" value="{{$emprecord->subindscodelist}}" class="form-control">
                                                @elseif(!empty($employer) && $employer->subindscodelist != '')
                                                <input type="text" id="subindscodelist" name="subindscodelist" value="{{$employer->subindscodelist}}" class="form-control">
                                                @else
