                ...
                <form action="/obform_sco" method="POST" id="reset">
                    ...
                    <div class="form-body">
                        {{-- <div class="row p-t-20">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label ">@lang('insuredPerson.attr.form34_receivedDate')</label><span class="required">*</span>
                        ...
                        {{-- <div class='row'>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">@lang('insuredPerson.attr.id_no')</label><span class="required">*</span>
                                    @if(!empty($obprofile) && $obprofile->idno !='')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">@lang('insuredPerson.attr.occupation') (Based on Form34)</label>
                        ...
                        <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="occucode" name="occucode" value="{{ $obprofile->occucode }}" class="form-control clearFields" >
                                        @elseif(!empty($obformassist) && $obformassist->occucode !='')
                                        <input type="text" id="occucode" name="occucode" value="{{ $obformassist->occucode }}" class="form-control clearFields">
                                        @else
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group"><br>
                                    <button type="button" class="btn btn waves-effect waves-light btn-success" data-toggle="modal" data-target="#exampleModal" data-whatever="@fat">@lang('insuredPerson.addRemark')</button>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog modal-xl" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header  card-title">
                                            <h4 class="modal-title" id="exampleModalLabel1">Notifications To Employer</h4>
                        ...
                        {{-- <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('insuredPerson.attr.under_act')</label>
                                    <input type="text" id="under_act" name="under_act" value="" class="form-control clearFields">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('insuredPerson.attr.under_act_date')</label>
                                    <input type="date" id="under_act_date" name="under_act_date" value="" class="form-control clearFields">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('insuredPerson.attr.ssab_decision')</label>
                                    <input type="text" id="ssab_decision" name="ssab_decision" value="" class="form-control clearFields">
                                </div>
                            </div>
                        </div> --}}
