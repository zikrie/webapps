            ...
            <div class="col-md-12">
                <div class="table-responsive" id="table-medical">
                    <div class="form-actions text-right">
                        <button type="button" id="btn_add_mc" value='0' class="btn btn-sm waves-effect waves-light btn-info">@lang('medicalDetails.addmc')</button>
                        ...
                        <tbody>
                            <tr data-expanded="true" class="workrow">
                                ...
                                <td>
                                    ...
                                    <button id="add_attended_work" value='0' type="button" class="btn btn-info" data-toggle="button" data-more="#sh" aria-pressed="false">
                                    ...
                                    "<table  id='table-medical-details"+i+"' class='table table-sm table-bordered' data-toggle-column='first'>"+
                                        ...
                                        "<tbody>"+
                                            ...
                                            " </td>"+
                                                ...
                                                "<td>"+
                                                    "<button type='button'  class='btn btn-sm btn-danger btn_del_workmc'><i class='fas fa-trash-alt fa-sm'></i></button>"+
                                                    "<button id='add_attended_work"+i+"' value='"+i+"' type='button' class='btn btn-info' data-toggle='button' data-more='#sh' aria-pressed='false'>"+
                                                        "<i class='ti-plus text' aria-hidden='true'></i>"+
                                                        "<i class='ti-plus text-active' aria-hidden='true'></i>"+
                                                    "</button>"+
                                                "</td>"+
