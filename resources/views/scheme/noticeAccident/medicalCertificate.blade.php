    ...
    <form method="post" action="{{ url('/updmc') }}">
                              ...
                              <div class="card-body">
                                <div class="row">
                                  <div class="form-actions text-right">
                                      <button type="button" id="btn_add_newMC" class="btn btn-sm waves-effect waves-light btn-info">@lang('medicalDetails.addMc')</button>
                                  </div>
                                  <table id="attended_work_tbl{{ $key }}" class="table table-sm table-bordered" data-toggle-column="first">
                                    <thead>
                                      <tr>
                                        <th style='width:30%'>@lang('medicalDetails.attr.type_hus')</th>
                                        ...
                                        <th style='width:320%'>@lang('medicalDetails.attr.action')</th>
                                      </tr>
                                    </thead>
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          ...
                                          <button id="btn_add_workmc{{ $key }}" value='0' type="button" class="btn btn-info btn_add_workmc" data-toggle="button" data-more="#sh" aria-pressed="false">
      ...
      <div class="form-actions text-right">
        ...
        @lang('insuredPerson.save')</button>
          <button type="button" id="btn_add_mc" class="btn btn-sm waves-effect waves-light btn-info">@lang('medicalDetails.addClinic')</button>
...
$(document).ready(function() {
  ...
  $('#container').on('click','.btn_add_workmc',function(e){
    ...
    html2 = "<tr class='workrow'>"+
                "<td><div class='form-group'> <input  name='attendedwork' type='text' value='Attended Work' class='form-control counttotalwork' readonly></div></td>"+
