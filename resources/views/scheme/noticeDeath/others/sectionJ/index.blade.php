...
<div class="card-body p-b-0">
    ...
    <h4 class="card-title">Section J</h4>


        <!-- Nav tabs -->
    <ul class="nav customtab" role="tablist" id="tabMenu">
    
        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#sectionj" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Section J</span></a> </li>
    ...
    <div class="tab-content tabcontent-border">
        ...
        <div class="tab-pane p-20 active" id="sectionj" role="tabpanel">
            @include('scheme.noticeDeath.others.sectionJ.collapse')
        </div>

            <!-- Wages tab -->
        <div class="tab-pane p-20" id="upload" role="tabpanel">
         @include('scheme.noticeDeath.others.sectionJ.collapse_doc')
      </div>
    </div>
</div>
