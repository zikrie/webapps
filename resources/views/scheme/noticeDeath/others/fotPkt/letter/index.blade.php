...
<div class="card-body p-b-0">
    ...
    <h4 class="card-title">Declaration 117 FOT and PKT</h4>

        <!-- Nav tabs -->
    <ul class="nav customtab" role="tablist" id="tabMenu">
    
        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#fotpkt" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Declaration 117</span></a> </li>
    ...
    <div class="tab-content tabcontent-border">
        ...
        <div class="tab-pane p-20 active" id="fotpkt" role="tabpanel">
            @include('scheme.noticeDeath.others.fotPkt.letter.collapse')
        </div>

            <!-- Wages tab -->
        <div class="tab-pane p-20" id="upload" role="tabpanel">
         @include('scheme.noticeDeath.others.fotPkt.letter.collapse_doc')
      </div>
    </div>
</div>
