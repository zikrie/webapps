...
<div class="card-body p-b-0">
    ...
    <ul class="nav customtab" role="tablist" id="tabMenu">
        ...
        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#deathdate" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Revision</span></a> </li>
    ...
    <div class="tab-content tabcontent-border">
        ...
        <div class="tab-pane p-20 active" id="deathdate" role="tabpanel">
            @include('scheme.noticeDeath.revision.deathDate.SAO.collapse')
        </div>

            <!-- Wages tab -->
        <div class="tab-pane p-20" id="upload" role="tabpanel">
            @include('scheme.noticeDeath.revision.deathDate.SAO.collapse_doc')
      </div>
    </div>
</div>
