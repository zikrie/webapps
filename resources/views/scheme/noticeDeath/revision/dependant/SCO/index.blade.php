...
<div class="card-body p-b-0">
    ...
    <h4 class="card-title">Revision of Dependant</h4>


        <!-- Nav tabs -->
    <ul class="nav customtab" role="tablist" id="tabMenu">
    
        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#dependant" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Revision</span></a> </li>
    ...
    <div class="tab-content tabcontent-border">
        ...
        <div class="tab-pane p-20 active" id="dependant" role="tabpanel">
            @include('scheme.noticeDeath.revision.dependant.SCO.collapse')
        </div>

            <!-- Wages tab -->
        <div class="tab-pane p-20" id="upload" role="tabpanel">
            @include('scheme.noticeDeath.revision.dependant.SCO.collapse_doc')
      </div>
    </div>
</div>
