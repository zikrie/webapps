                            ...
                            <div class="row p-t-20">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="mode_transport_other" class="form-control">
                                    ...
                                    <div class="col-md-6 mb-6">
                                        <input name="others" id="others" type="text" class="form-control"
                                            placeholder="@lang('accidentDetails.other_trans')">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
