...
<section>
    <div class="row p-t-20">
        ...
        <div class="row p-t-20">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label">@lang('confirmation.attr.acceptance_stamp')
                        </label>
                        <input type="date" name="acceptance_stamp_date" id="acceptance_stamp_date" class="form-control">
                    </div>
                </div>
            </div>
            <div class="row p-t-20">
