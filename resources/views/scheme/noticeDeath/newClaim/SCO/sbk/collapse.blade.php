            ...
            <div id="accordion2" role="tablist" class="accordion" >
                ...
                <div class="card m-b-0">
                    ...
                    <div id="collapsePreparer" class="collapse" role="tabpanel" aria-labelledby="headingPreparer">
                        <div class="card-body">
                            @include('scheme.noticeDeath.newClaim.SCO.general.prepare')
                        </div>
                    </div>
                </div>
                <!-- Case Info -->
                ...
                <div class="card m-b-0">
                    ...
                    <div id="collapseCertification" class="collapse" role="tabpanel" aria-labelledby="headingCertification">
                        <div class="card-body">
                            @include('scheme.noticeDeath.newClaim.SCO.general.certification')
                        </div>
                    </div>
                </div>
                <!-- Ob Form -->
                ...
                <div class="card m-b-0">
                    ...
                    <div id="collapseSocso" class="collapse" role="tabpanel" aria-labelledby="headingSocso">
                        <div class="card-body">
                            @include('scheme.noticeDeath.newClaim.SCO.general.socso')
                        </div>
                    </div>
                </div>
