            ...
            <div id="accordion2" role="tablist" class="accordion" >
                ...
                <div class="card m-b-0">
                    ...
                    <div id="collapsePreparer" class="collapse" role="tabpanel" aria-labelledby="headingPreparer">
                        <div class="card-body">
                            @include('scheme.noticeDeath.newClaim.SCO.fpm.prepare')
                        </div>
                    </div>
                </div>
                <!-- Case Info -->
                <div class="card m-b-0">
                    ...
                    <div id="collapseCaseinfo" class="collapse" role="tabpanel" aria-labelledby="headingCaseinfo">
                        <div class="card-body">
                            @include('scheme.noticeDeath.newClaim.SCO.fpm.case_info')
                        </div>
                    </div>
                </div>
                <!-- Case Info -->
                <div class="card m-b-0">
                    ...
                    <div id="collapseCertification" class="collapse" role="tabpanel" aria-labelledby="headingCertification">
                        <div class="card-body">
                            @include('scheme.noticeDeath.newClaim.SCO.fpm.certification')
                        </div>
                    </div>
                </div>
                 <!-- Scheme Qualifying -->
                 <div class="card m-b-0">
                    ...
                    <div id="collapseQualifying" class="collapse" role="tabpanel" aria-labelledby="headingQualifying">
                        <div class="card-body">
                            @include('scheme.noticeDeath.newClaim.SCO.fpm.scheme_qualifying')
                        </div>
                    </div>
                </div>
                <!-- Ob Form -->
                <div class="card m-b-0">
                    ...
                    <div id="collapseOb" class="collapse" role="tabpanel" aria-labelledby="headingOb">
                        <div class="card-body">
                            @include('scheme.noticeDeath.newClaim.SCO.fpm.ob')
                        </div>
                    </div>
                </div>
                <!-- Employer Details -->
                ...
                <div class="card m-b-0">
                    ...
                    <div id="collapseWages" class="collapse" role="tabpanel" aria-labelledby="headingWages">
                        <div class="card-body">
                            @include('scheme.noticeDeath.newClaim.SCO.fpm.wages')
                        </div>
                    </div>
                </div>
                <!-- Death Details -->
                <div class="card m-b-0">
                    ...
                    <div id="collapseDeath" class="collapse" role="tabpanel" aria-labelledby="headingDeath">
                        <div class="card-body">
                            @include('scheme.noticeDeath.newClaim.SCO.fpm.death')
                        </div>
                    </div>
                </div>
                <!-- Dependant Details -->
                <div class="card m-b-0">
                    ...
                    <div id="collapseDependant" class="collapse" role="tabpanel" aria-labelledby="headingDependant">
                        <div class="card-body">
                            @include('scheme.noticeDeath.newClaim.SCO.fpm.dependant')
                        </div>
                    </div>
                </div>
                <!-- Applicant Details -->
                ...
                <div class="card m-b-0">
                    ...
                    <div id="collapseFact" class="collapse" role="tabpanel" aria-labelledby="headingFact">
                        <div class="card-body">
                            @include('scheme.noticeDeath.newClaim.SCO.fpm.case_fact')
                        </div>
                    </div>
                </div>
                <!-- Socso Details -->
