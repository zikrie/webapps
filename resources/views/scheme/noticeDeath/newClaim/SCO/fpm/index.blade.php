...
<div class="card-body p-b-0">
    ...
    <div class="tab-content tabcontent-border">
        ...
        <div class="tab-pane p-20" id="investigation" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.SCO.fpm.investigation')
        </div>
            <!-- Query and Opinion tab -->
        <div class="tab-pane p-20" id="query" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.SCO.fpm.collapse_query')
        </div>
            <!-- Recommendation tab -->
        ...
        <div class="tab-pane p-20" id="fpminfo" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.SCO.fpm.collapse_fpminfo')
        </div>
