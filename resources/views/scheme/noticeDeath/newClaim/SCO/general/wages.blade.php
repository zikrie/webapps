           ...
           <div class="card-body">
               <form action="#">
                   <div class="form-body">
                       ...
                       <h6 class="card-title-sub">@lang('form/scheme.general.collapse.similar.title')</h6>
                       <hr>
                       <div class="row p-t-20">
                           <div class="col-md-4">
                               <div class="form-group">
                               ...
                               <div class="card">
                                   ...
                                   <div class="table-responsive">
                                       <table id="demo-foo-row-toggler" class="table table-bordered"
                                           ...
                                           <thead>
                                               <tr>
                                                   <th style='width:1%' data-breakpoints="xs" class="text-center">@lang('table-header.wages.num')</th>
                                                   <th style='width:9%' class="text-center">@lang('table-header.wages.year')</th>
                                                   <th style='width:16%' class="text-center">@lang('table-header.wages.month')</th>
                                                   <th style='width:15%' class="text-center">@lang('table-header.wages.wages')</th>
                                                   <th style='width:15%' class="text-center">@lang('table-header.wages.contribution_paid')</th>
                                                   <th style='width:15%' class="text-center">@lang('table-header.wages.contribution_payable')</th>
                                                   {{-- <th style='width:15%' class="text-center">@lang('wages.attr.contribution')</th> --}}
                                                   <th style='width:15%' class="text-center">@lang('table-header.wages.contribution_surplus')</th>
                                                   <th style='width:5%' class="text-center">@lang('table-header.wages.accept')</th>
                                                   <th style='width:20%' class="text-center">@lang('table-header.wages.reason')</th>
                                               </tr>
                                           </thead>
                                           <tbody>
               ...
               <div class="similar_work" id="similar_work">
                   @include('scheme.noticeDeath.newClaim.SCO.general.similar')
