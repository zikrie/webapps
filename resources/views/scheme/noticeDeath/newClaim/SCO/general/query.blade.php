...
$(document).ready(function() {
   ...
   $('#btn_add_opinion0').click(function(){
      ...
      html = '<h6 class="card-title-sub">Opinion</h6>'+
               '<hr>'+
               '<div class="row">'+
                  '<div class="col-md-4">'+
                     '<div class="form-group">'+
                        '<label class="control-label">Case Details</label>'+
                        '<textarea id="" name="" value="" class="form-control clear_death"></textarea>'+
                     '</div>'+
                  '</div>'+
               '</div>'+
               '<div class="row">'+
               ...
               '<div class="row">'+
                  '<div class="col-md-4">'+
                     '<div class="form-group">'+
                        ...
                        '<textarea id="" name="" value="" placeholder="Description" class="form-control clear_death"></textarea>'+
                     '</div>'+
                  '</div>'+
               '</div>'+
               '<div class="row">'+
                  '<div class="col-md-4">'+
                     '<div class="form-group">'+
                        '<button type="button" id="btn_save_opinion" value="0" class="btn btn-sm waves-effect waves-light btn-info text-right">SAVE</button>'+
                     '</div>'+
                  '</div>'+
               '</div>';
