...
<div class="card-body p-b-0">
    ...
    <ul class="nav customtab" role="tablist" id="tabMenu">
        ...
        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#recommendation" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">@lang('form/scheme.general.tab_title.recommendation')</span></a> </li>
        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#statements" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Statement</span></a> </li>
    ...
    <div class="tab-content tabcontent-border">
        ...
        <div class="tab-pane p-20 active" id="remarks" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.SAO.remarks')
        </div>
        <!-- Claim Details tab -->
        <div class="tab-pane p-20" id="claim" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.SAO.collapse')
        </div>
        <!-- Investigation tab -->
        <div class="tab-pane p-20" id="investigation" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.SAO.collapse_investigation')
        </div>
            <!-- Recommendation tab -->
        <div class="tab-pane p-20" id="recommendation" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.SAO.collapse_rec')
        </div>
            <!-- Statements tab -->
        <div class="tab-pane p-20" id="statements" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.SAO.collapse_statement')
        </div>
            <!-- Supporting Document tab -->
        <div class="tab-pane p-20" id="upload" role="tabpanel">
            @include('scheme.noticeDeath.newClaim.SAO.collapse_upload')
        </div>
    </div>
</div>
