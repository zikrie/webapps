                      ...
                      <input type="hidden" name="_token" value="{{csrf_token()}}">
                        ...
                        <div class="form-body">  
                           <div class='row'>
                              <div class="col-md-12">
                                  <div class="form-group">
                                      <label for="exampleInputEmail1">Employment Injury Decision</label>
                           ...
                           <div class='row'>
                              <div class="col-md-4">
                                  <div class="form-group">
                                      <label for="exampleInputEmail1">Scheme Recommended Date</label>
                                      <input type="date" class="form-control clearFields" id='emprepdes' name="emprepdes" value="" required>
                                  </div>
                              </div>
                              <div class="col-md-4">
                                  <div class="form-group">
                                      <label for="exampleInputPassword1">Scheme Recommended By</label>
                           ...
                           <div class='row'>
                                 <div class="col-md-4">
                                     <div class="form-group">
                                         <label for="exampleInputEmail1">Scheme Approved Date</label>
                                         <input type="date" class="form-control clearFields" id='emprepdes' name="emprepdes" value="" required>
                                     </div>
                                 </div>
                                 <div class="col-md-4">
                                     <div class="form-group">
                                         <label for="exampleInputPassword1">Scheme Approved By</label>
                                             <input type="text" class="form-control clearFields" id='emprepdes' name="emprepdes" value="" required>
                                     </div>
                                 </div>
                              </div>
