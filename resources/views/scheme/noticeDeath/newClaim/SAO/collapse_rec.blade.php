         ...
         <div id="accordion2" role="tablist" class="accordion" >
            ...
            <div class="card m-b-0">
               ...
               <div id="collapseInconsistency" class="collapse" role="tabpanel" aria-labelledby="headingInconsistency">
                  <div class="card-body">
                     @include('scheme.noticeDeath.newClaim.SAO.inconsistency')
                  </div>
               </div>
            </div>
            <!-- Recommendation -->
            <div class="card m-b-0">
               <div class="card-header" role="tab" id="headingRecommendation">
                  <h6 class="mb-0">                           
                     ...
                     @lang('form/scheme.general.collapse.recommendation.title')</h6>
                     </a>
                  </h6>
               </div>
               <div id="collapseRecommendation" class="collapse" role="tabpanel" aria-labelledby="headingRecommendation">
                  <div class="card-body">
                     @include('scheme.noticeDeath.newClaim.SAO.recommendation')
                  </div>
               </div>
            </div>
         </div>
