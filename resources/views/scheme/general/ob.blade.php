                ...
                <form action="/obform_sco" method="POST" id="reset">
                    ...
                    <div class="form-body">
                        <div class="row p-t-20">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label
                                        class="control-label ">@lang('scheme/ob.attr.form34_receivedDate')</label><span
                                        class="required">*</span>
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">@lang('scheme/ob.attr.name')</label><span
                                        class="required">*</span>
                    ...
                    <div class='row'>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">@lang('scheme/ob.attr.dateOfBirth')</label><span
                                    class="required">*</span>
