                        ...
                        <div class="col-md-8">
                            <div class="table-responsive" id="table-generated">
                                <table  class="table table-sm table-bordered" data-toggle-column="first">
                                    <thead>
                                        <tr>
                                            <th style='width:25%'>@lang('scheme/uploaddoc.attr.doc_desc')</th> 
                                            <th style='width:5%'>@lang('scheme/uploaddoc.attr.generated_date')</th> 
                                            <th style='width:1%'>@lang('scheme/uploaddoc.attr.view')</th> 
                                        </tr>
                                    </thead>
                                    <tbody>
