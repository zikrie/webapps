<div id="accordion2" role="tablist" class="accordion">
    ...
    <div class="card m-b-0">
        ...
        <div id="creditPeriod" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.newClaim.IO.credit')
            </div>
        </div>
    </div>
    <div class="card m-b-0">
        ...
        <div id="contri56" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.newClaim.IO.contribution56')
            </div>
        </div>
    </div>
    <div class="card m-b-0">
        ...
        <div class="card m-b-0">
            ...
            <div id="invalidityNoticeDetails" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.newClaim.IO.invalidNoticeDetails')
                </div>
            </div>
        </div>
        ...
        <div class="card m-b-0">
            ...
            {{-- <div class="card m-b-0">
                ...
                <div id="investigateDetails" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                    <div class="card-body">
                        @include('scheme.noticeInvalidity.newClaim.IO.investigation')
                    </div>
                </div>
            </div> --}}
            <div class="card m-b-0">
