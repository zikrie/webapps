                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-actions">
                                ...
                                <a href="/ilatpreview" id='preview' type="button" name="action" value="Preview"
                                    class="btn btn-secondary">@lang('scheme/confirmation.preview')</a>
                                ...
                                <button type="submit" name="action" value="Save"
                                    class="btn waves-effect waves-light btn-success">@lang('scheme/confirmation.save')</button>
                            </div>
                        </div>
                    </div>
                    <br />
