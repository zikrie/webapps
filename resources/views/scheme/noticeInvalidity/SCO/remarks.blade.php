                ...
                <form action="/remark" method="POST">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-actions">
                            <button type="button"
                                class="btn btn waves-effect waves-light btn-secondary">@lang('permanentRepresentative.cancel')</button>
                            <button type="button"
                                class="btn btn waves-effect waves-light btn-secondary">@lang('permanentRepresentative.clear')</button>
