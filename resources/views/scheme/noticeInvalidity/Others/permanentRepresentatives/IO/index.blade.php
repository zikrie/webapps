        ...
        <div class="card-body">
            ...
            <div class="tab-content tabcontent-border">
                ...
                <div class="tab-pane p-20 active" id="remarks" role="tabpanel">
                        @include('scheme.noticeInvalidity.Others.permanentRepresentatives.IO.remarks')
                </div>
                ...
                <div class="tab-pane p-20 " id="recommend" role="tabpanel">
                        @include('scheme.noticeInvalidity.Others.permanentRepresentatives.IO.recommendation')
                </div>

                <div class="tab-pane p-20 " id="claimDetails" role="tabpanel">
                        @include('scheme.noticeInvalidity.Others.permanentRepresentatives.IO.collapse')
                </div>
            </div>
        </div>
    </div>
