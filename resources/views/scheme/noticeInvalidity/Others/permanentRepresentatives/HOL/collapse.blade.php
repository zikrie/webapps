<div id="accordion2" role="tablist" class="accordion">
        <div class="card m-b-0">
            ...
            <div id="generate_appendix" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.generate_appendix')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="accAppendix" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.acceptance_appendix')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="Installation" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.installation')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="AppendixB" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.pr_letter')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="AppendixB1" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.presentation')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="rejectMail" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.approve')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="office" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.office')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="ak" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.ak')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="finance" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.finance')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="disbursement" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.disbursement')
                </div>
            </div>
        </div> 
        <div class="card m-b-0">
            ...
            <div id="before" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.before')
                </div>
            </div>
        </div> 
        <div class="card m-b-0">
            ...
            <div id="printDoc" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.interim')
                </div>
            </div>
        </div>
        ...
        <div class="card m-b-0">
            ...
            <div id="disclaimer" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.disclaimer')
                </div>
            </div>
        </div>
    </div>