...
<div class="row">
    <div class="col-md-12">
        <div class="card-body">
            <h3 class="card-title">@lang('Permananet Representatives')</h3>
            <!-- Tab panes -->
            ...
            <div class="tab-content tabcontent-border">
                ...
                <div class="tab-pane p-20 active" id="remarks" role="tabpanel">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.remarks')
                </div>
                ...
                <div class="tab-pane p-20 " id="recommend" role="tabpanel">
                        @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.recommendation')
                    </div>
                <div class="tab-pane p-20 " id="claimDetails" role="tabpanel">
                        @include('scheme.noticeInvalidity.Others.permanentRepresentatives.HOL.collapse')
