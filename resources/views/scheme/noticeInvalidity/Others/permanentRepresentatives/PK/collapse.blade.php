                ...
                <h5 class="mb-0">
                    <a class="link" data-toggle="collapse" data-parent="#accordion2"
                        ...
                        <h4 class="card-title"><i class="fa fa-plus"></i>
                            @lang('index.attr.generateAppendixA')
                        </h4>
                    </a>
                </h5>
            </div>
            ...
            <div class="card-header" role="tab" id="appendixE">
                <h5 class="mb-0">
                    <a class="link" data-toggle="collapse" data-parent="#accordion2" href="#AppendixE"
                        aria-expanded="false" aria-controls="collapseOne1">
                        <h4 class="card-title"><i class="fa fa-plus"></i>
                            @lang('index.attr.PRMailAppendixE')
                        </h4>
                    </a>
                </h5>
            </div>
            ...
            <div class="card m-b-0">
                    ...
                    <div class="card-header" role="tab" id="PRMailAppendixB">
                        <h5 class="mb-0">
                            <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                ...
                                <h4 class="card-title"><i class="fa fa-plus"></i>
                                    @lang('index.attr.MailAppendixB1')
                                </h4>
                            </a>
                        </h5>
                    </div>
                ...
                <div class="card m-b-0">
                    <div class="card-header" role="tab" id="rejectionMail">
                        <h5 class="mb-0">
                            <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                href="#rejectMail" aria-expanded="false" aria-controls="collapseOne1">
                                <h4 class="card-title"><i class="fa fa-plus"></i>
                                    @lang('index.attr.rejectionMail')
                                </h4>
                            </a>
                        </h5>
                    </div>
                   ...
                   <div class="card m-b-0">
                    <div class="card-header" role="tab" id="afterPrintDoc">
                        <h5 class="mb-0">
                            <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                href="#printDoc" aria-expanded="false" aria-controls="collapseOne1">
                                <h4 class="card-title"><i class="fa fa-plus"></i>
                                    @lang('index.attr.afterPrintDoc')
                                </h4>
                            </a>
                        </h5>
                    </div>
                   ...
                   <div class="card m-b-0">
                    <div class="card-header" role="tab" id="SuratKebenaran">
                        <h5 class="mb-0">
                            <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                href="#surat" aria-expanded="false" aria-controls="collapseOne1">
                                <h4 class="card-title"><i class="fa fa-plus"></i>
                                    @lang('index.attr.suratKebenaran')
                                </h4>
                            </a>
                        </h5>
                    </div>
                    ...
                    <div class="card-header" role="tab" id="perbatalanWakilTetap">
                        <h5 class="mb-0">
                            <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                ...
                                <h4 class="card-title"><i class="fa fa-plus"></i>
                                    @lang('index.attr.perbatalanWakilTetap')
                                </h4>
                            </a>
                        </h5>
                    </div>
                   ...
                   <div class="card m-b-0">
                    <div class="card-header" role="tab" id="submission">
                        <h5 class="mb-0">
                            <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                href="#Submissions" aria-expanded="false" aria-controls="collapseOne1">
                                <h4 class="card-title"><i class="fa fa-plus"></i>
                                    @lang('index.attr.submission')
                                </h4>
                            </a>
                        </h5>
                    </div>
                    <div id="Submissions" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                        <div class="card-body">
