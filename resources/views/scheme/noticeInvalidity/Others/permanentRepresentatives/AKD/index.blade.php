...
<div class="row">
    <div class="col-md-12">
        <div class="card-body">
            <h3 class="card-title">@lang('Permanent Representatives')</h3>
            <!-- Tab panes -->
            ...
            <ul class="nav customtab" role="tablist" id="tabMenu">
                ...
                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#recommend" role="tab"><span
                    class="hidden-sm-up"><i class="ti-home"></i></span> <span
                    class="hidden-xs-down">@lang('Recommended')</span></a>
        </li>
            ...
            <div class="tab-content tabcontent-border">
                ...
                <div class="tab-pane p-20 active" id="remarks" role="tabpanel">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.AKD.remarks')
                </div>
                ...
                <div class="tab-pane p-20 " id="recommend" role="tabpanel">
                        @include('scheme.noticeInvalidity.Others.permanentRepresentatives.AKD.recommendation')
                    </div>

                <div class="tab-pane p-20" id="claimDetails" role="tabpanel">
                        @include('scheme.noticeInvalidity.Others.permanentRepresentatives.AKD.collapse')
                </div>
            </div>
        </div>
    </div>
