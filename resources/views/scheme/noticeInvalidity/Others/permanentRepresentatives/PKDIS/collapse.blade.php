<div id="accordion2" role="tablist" class="accordion">
        <div class="card m-b-0">
            ...
            <div id="generate_appendix" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.PKDIS.generate_appendixPKD')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="accAppendix" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.PKDIS.acceptance_appendixpkd')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            <div class="card-header" role="tab" id="investigation">
                <h5 class="mb-0">
                    <a class="link" data-toggle="collapse" data-parent="#accordion2"
            ...
            <div id="Installation" class="collapse" role="tabpanel" aria-labelledby="investigation">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.PKDIS.investigationpkd')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            <div class="card-header" role="tab" id="letterE">
                <h5 class="mb-0">
                    <a class="link" data-toggle="collapse" data-parent="#accordion2" href="#letter"
                        aria-expanded="false" aria-controls="collapseOne1">
                        <h4 class="card-title"><i class="fa fa-plus"></i>
            ...
            <div id="letter" class="collapse" role="tabpanel" aria-labelledby="letterE">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.PKDIS.letterE')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="AppendixB1" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.PKDIS.recommendation')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="rejectMail" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.PKDIS.approval')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="printDoc" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.PKDIS.approval_headlocal')
                </div>
            </div>
        </div>
        ...
        <div class="card m-b-0">
            ...
            <div id="disbursementapprovalHof" class="collapse" role="tabpanel" aria-labelledby="disbursementapproval">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.PKDIS.approval_disbursement')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="financeapproval" class="collapse" role="tabpanel" aria-labelledby="financeapprovalHof">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.PKDIS.approval_finance')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="disbursement" class="collapse" role="tabpanel" aria-labelledby="pkdisbursement">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.PKDIS.pk_disbursement')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="docprinted" class="collapse" role="tabpanel" aria-labelledby="after_docprinted">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.PKDIS.after_documentprinted')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="interimHof" class="collapse" role="tabpanel" aria-labelledby="interim">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.PKDIS.interim')
                </div>
            </div>
        </div>
        <div class="card m-b-0">
            ...
            <div id="cancelation" class="collapse" role="tabpanel" aria-labelledby="cancelationPR">
                <div class="card-body">
                    @include('scheme.noticeInvalidity.Others.permanentRepresentatives.PKDIS.cancelationPR')
                </div>
            </div>
        </div>
    </div>