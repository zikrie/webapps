    ...
    <div class="col-md-12">
        <div class="card-body">
            ...
            <ul class="nav customtab" role="tablist" id="tabMenu">
                ...
                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#supportingdoc" id="nav_uploaddoc"
                        role="tab"><span class="hidden-sm-up"><i class="ti-files"></i></span> <span
                            class="hidden-xs-down">
            ...
            <div class="tab-content tabcontent-border">
                ...
                <div class="tab-pane p-20 " id="collapse" role="tabpanel">
                    @include('scheme.noticeInvalidity.SAO.collapse')
                </div>
