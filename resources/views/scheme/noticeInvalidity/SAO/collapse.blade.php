<div id="accordion2" role="tablist" class="accordion">
    ...
    <div class="card m-b-0">
        ...
        <div id="caseinfo" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.SAO.caseinfo')
            </div>
        </div>
    </div>
    <div class="card m-b-0">
        ...
        <div id="ob" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.SAO.ob')
            </div>
        </div>
    </div>
    <div class="card m-b-0">
        ...
        <div id="wagesInfo" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.SAO.wagesInfo')
            </div>
        </div>
    </div>
    <div class="card m-b-0">
        ...
        <div id="contriInfo" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.SAO.contriInfo')
            </div>
        </div>
    </div>
    <div class="card m-b-0">
        ...
        <div id="creditPeriod" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.SAO.credit')
            </div>
        </div>
    </div>
    <div class="card m-b-0">
        ...
        <div id="contri56" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.SAO.contribution56')
            </div>
        </div>
    </div>
    <div class="card m-b-0">
    ...
    <div class="card m-b-0">
        ...
        <div id="aidWages" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.SAO.aidWages')
            </div>
        </div>
    </div>
    <div class="card m-b-0">
        ...
        <div id="invalidityNoticeDetails" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.SAO.invalidNoticeDetails')
            </div>
        </div>
    </div>
    <div class="card m-b-0">
        ...
        <div id="medicalBoard" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.SAO.medicalboard')
            </div>
        </div>
    </div>
    <div class="card m-b-0">
        ...
        <div id="socso" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.SAO.sosco')
            </div>
        </div>
    </div>
    <div class="card m-b-0">
        ...
        <div id="permanent" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.SAO.permanent')
            </div>
        </div>
    </div>
    ...
    <div class="card m-b-0">
        ...
        <div id="confirmation" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.SAO.confirmation')
            </div>
        </div>
    </div>
    {{-- <div class="card m-b-0">
        ...
        <div id="recommend" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
            <div class="card-body">
                @include('scheme.noticeInvalidity.SAO.recommendation')
            </div>
        </div>
    </div> --}}
</div>
