                                ...
                                <table id="demo-foo-row-toggler" class="table table-bordered"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-breakpoints="xs sm">@lang('scheme/wages.attr.contribution')</th>
                                            <th>No of Contribution for the year</th>
                                            <th>Total employee Contribution for the year(RM)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr data-expanded="true">
                                            ...
                                            <td>
                                                <select class="form-control" data-placeholder="Month" tabindex="2">
                                                    {{-- <option>@lang('scheme/wages.attr.select_month')</option> --}}
                                                    <option value="January">@lang('scheme/wages.attr.january')</option>
                                                    <option value="February">@lang('scheme/wages.attr.february')
                                                    </option>
                                                    ...
                                                    <option value="September">@lang('scheme/wages.attr.september')
                                                    </option>
                                                    <option value="October">@lang('scheme/wages.attr.october')</option>
                                                    <option value="November">@lang('scheme/wages.attr.november')
                                                    </option>
                                                    <option value="December">@lang('scheme/wages.attr.december')
                                                    </option>
                                                </select>
                                            </td>
