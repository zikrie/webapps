                    ...
                    <div class="form-body">
                        ...
                        <div class="row p-t-20">
                            ...
                            <div class="form-actions">
                                <button type="button"
                                    class="btn btn waves-effect waves-light btn-secondary">@lang('scheme/permanent.cancel')</button>
                                <button type="button"
                                    class="btn btn waves-effect waves-light btn-secondary">@lang('scheme/permanent.clear')</button>
