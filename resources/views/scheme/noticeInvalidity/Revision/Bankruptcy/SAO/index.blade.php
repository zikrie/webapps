                ...
                <div class="col-md-12">
                    <div class="card-body">
                        <ul class="nav customtab" role="tablist" id="tabMenu">
                            ...
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#recommend"
                                role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span
                                    class="hidden-xs-down">@lang('Recommendation')</span></a>
                        </li>
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#uploadodc"
                                    role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span
                        ...
                        <div class="tab-content tabcontent-border">
                            ...
                            <div class="tab-pane p-20 active" id="remarks" role="tabpanel">
                                @include('scheme.noticeInvalidity.Revision.Bankruptcy.PK.remarks')
                            </div>
                            <div class="tab-pane p-20" id="collapse" role="tabpanel">
                                @include('scheme.noticeInvalidity.Revision.Bankruptcy.SAO.collapse')
                            </div>
                            <div class="tab-pane p-20" id="recommend" role="tabpanel">
                                    @include('scheme.noticeInvalidity.Revision.Bankruptcy.SAO.recommendation')
                                </div>

                            <div class="tab-pane p-20" id="uploadodc" role="tabpanel">
