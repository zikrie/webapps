                ...
                <form action="/caseinfo_revision" method="POST">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">@lang('insuredPerson.attr.name')</label><span
                                        class="required">*</span>
                        ...
                        <div class='row'>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">@lang('insuredPerson.attr.mobileNo')</label><span
                                        class="required">*</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">@lang('insuredPerson.attr.email')</label><span
                                        class="required">*</span>
                        ...
                        <div class='row'>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>@lang('insuredPerson.attr.postal_address')</label><span
                                        class="required">*</span>
