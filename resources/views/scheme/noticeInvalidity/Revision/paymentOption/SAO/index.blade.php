...
<div class="row">
    <div class="col-md-12">
        <div class="card-body">
            <h4 class="card-title">@lang('Payement Option')</h4>
            <!-- Tab panes -->
                ...
                <div class="tab-pane p-20" id="claimDetails" role="tabpanel">
                    ...
                    <div id="accordion2" role="tablist" class="accordion">
                        ...
                        <div class="card m-b-0">
                            <div class="card-header" role="tab" id="caseInfoSAO_Payment">
                                <h5 class="mb-0">
                            ...
                            <div id="caseInfo" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                <div class="card-body">
                                    @include('Scheme.noticeInvalidity.Revision.paymentOption.SAO.case_infoSAO')
                                </div>
                            </div>
                        </div>
                        <div class="card m-b-0">
                            <div class="card-header" role="tab" id="applicantInfo_PaymentSAO">
                                <h5 class="mb-0">
                                    <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                        ...
                                        <h4 class="card-title"><i class="fa fa-plus"></i> Applicant Information
                                        </h4>
                                    </a>
                                </h5>
                            </div>
                            <div id="applicantInfo" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                <div class="card-body">
                                    @include('Scheme.noticeInvalidity.Revision.paymentOption.SAO.applicant_infoSAO')
                                </div>
                            </div>
                        </div>
                        <div class="card m-b-0">
                            <div class="card-header" role="tab" id="insuredPersonInfo_paymentOptionSAO">
                                <h5 class="mb-0">
                                    <a class="link" data-toggle="collapse" data-parent="#accordion2"
                            ...
                            <div id="insuredPerson" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                <div class="card-body">
                                    @include('Scheme.noticeInvalidity.Revision.paymentOption.SAO.ob_infoSAO')
                                </div>
                            </div>
                        </div>
                        <div class="card m-b-0">
                            <div class="card-header" role="tab" id="medicalboard_paymentOptionSAO">
                                <h5 class="mb-0">
                                    <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                        href="#medicalboard" aria-expanded="false" aria-controls="collapseOne1">
                                        <h4 class="card-title"><i class="fa fa-plus"></i>
                            ...
                            <div id="medicalboard" class="collapse" role="tabpanel" aria-labelledby="medicalboard_paymentOptionSAO">
                                <div class="card-body">
                                    @include('Scheme.noticeInvalidity.Revision.paymentOption.SAO.medical_board')
                                </div>
                            </div>
                        </div>
                        <div class="card m-b-0">
                            <div class="card-header" role="tab" id="paymentOption_medicalSAO">
                                <h5 class="mb-0">
                                    <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                        href="#paymentOptionSAO" aria-expanded="false" aria-controls="collapseOne1">
                                        <h4 class="card-title"><i class="fa fa-plus"></i>
                                            Payment Option
                                        </h4>
                                    </a>
                            ...
                            <div id="paymentOptionSAO" class="collapse" role="tabpanel" aria-labelledby="paymentOption_medicalSAO">
                                <div class="card-body">
                                    @include('Scheme.noticeInvalidity.Revision.paymentOption.SAO.payment_optionSAO')
                                </div>
                            </div>
                        </div>
                        <div class="card m-b-0">
                            <div class="card-header" role="tab" id="approvalSAO">
                                <h5 class="mb-0">
                                    <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                        href="#approval" aria-expanded="false" aria-controls="collapseOne1">
                                        <h4 class="card-title"><i class="fa fa-plus"></i>
                                            Approval
                                        </h4>
                                    </a>
                            ...
                            <div id="approval" class="collapse" role="tabpanel" aria-labelledby="approvalSAO">
                                <div class="card-body">
                                    @include('Scheme.noticeInvalidity.Revision.paymentOption.SAO.approval')
                                </div>
                            </div>
                        </div>
                    </div>
