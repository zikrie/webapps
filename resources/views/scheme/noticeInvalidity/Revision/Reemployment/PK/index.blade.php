...
<div class="row">
    <div class="col-md-12">
        <div class="card-body">
            <h3 class="card-title">@lang('Revision Reemployment')</h3>
            <!-- Tab panes -->
            ...
            <div class="tab-content tabcontent-border">
                ...
                <div class="tab-pane p-20 active" id="remarks" role="tabpanel">
                    @include('Scheme.noticeInvalidity.Revision.Reemployment.PK.remarks')
                </div>
                ...
                <div class="tab-pane p-20" id="claimDetails" role="tabpanel">
                    ...
                    <div id="accordion2" role="tablist" class="accordion">
                        ...
                        <div class="card m-b-0">
                            <div class="card-header" role="tab" id="caseInfo_reemployment">
                                <h5 class="mb-0">
                            ...
                            <div id="caseInfo" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                <div class="card-body">
                                    @include('Scheme.noticeInvalidity.Revision.Reemployment.PK.case_info')
                                </div>
                            </div>
                        </div>
                        <div class="card m-b-0">
                            <div class="card-header" role="tab" id="insuredPerson_medical">
                                <h5 class="mb-0">
                            ...
                            <div id="obInfo" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                <div class="card-body">
                                    @include('Scheme.noticeInvalidity.Revision.Reemployment.PK.ob_info') </div>
                            </div>
                        </div>
                        <div class="card m-b-0">
                            <div class="card-header" role="tab" id="employerInfo_reemployment">
                                <h5 class="mb-0">
                                    <a class="link" data-toggle="collapse" data-parent="#accordion2"
                                        href="#employerInfo" aria-expanded="false" aria-controls="collapseOne1">
                                        <h4 class="card-title"><i class="fa fa-plus"></i>
                                            @lang('Employer Info')
                                        </h4>
                                    </a>
                            ...
                            <div id="employerInfo" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                                <div class="card-body">
                                    @include('Scheme.noticeInvalidity.Revision.Reemployment.PK.employer_info') </div>
                            </div>
                        </div>
                    </div>
                </div>
