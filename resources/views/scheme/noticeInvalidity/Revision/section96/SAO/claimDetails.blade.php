...
<div class="card m-b-0">
    <div class="card-header" role="tab" id="headingOne2">
        <h5 class="mb-0">                           
            <a class="link" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne2" aria-expanded="false" aria-controls="collapseOne2"><h4 class="card-title"><i class="fa fa-plus"></i>
...
<div class="card m-b-0">
    <div class="card-header" role="tab" id="headingOne6">
        <h5 class="mb-0">                           
            <a class="link" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne6" aria-expanded="false" aria-controls="collapseOne6"><h4 class="card-title"><i class="fa fa-plus"></i>
            Suggestion</h4>
        </a>
    </h5>
</div>
...
<div class="card m-b-0">
    <div class="card-header" role="tab" id="headingSuggestion">
        <h5 class="mb-0">                           
            <a class="link" data-toggle="collapse" data-parent="#accordion2" href="#collapseSuggestion" aria-expanded="false" aria-controls="collapseSuggestion"><h4 class="card-title"><i class="fa fa-plus"></i>
            Confirmation</h4>
        </a>
    </h5>
</div>
<div id="collapseSuggestion" class="collapse" role="tabpanel" aria-labelledby="headingSuggestion">
    <div class="card-body">
