                    ...
                    <form action="/caseinfo_revision" method="POST">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row p-t-20">
                                ...
                                <label class="control-label">@lang('Source')</label><span class="required">*</span>
                                       <select class="form-control" data-placeholder="source_invalidity" tabindex="2">
                                            ...
                                            <option value="">@lang('wages.attr.JRKS')</option>
                            ...
                            <div class="row p-t-20">
                               <div class="col-md-4">
                                    <div class="form-group">
                                    <label class="control-label">@lang('Year')</label><span class="required">*</span><span class="required">*</span>
                                    <input type="date" id="year_invalidity" name="year" value="" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                       <label class="control-label">@lang('Acceptance Declaration')</label><span class="required">*</span>
