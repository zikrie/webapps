<div id="accordion2" role="tablist" class="accordion">
        ...
        <div class="card m-b-0">
            <div class="card-header" role="tab" id="reco">
                <h5 class="mb-0">
                    <a class="link" data-toggle="collapse" data-parent="#accordion2" href="#recomendation" aria-expanded="false" aria-controls="collapseOne1">
                        <h4 class="card-title"><i class="fa fa-plus"></i>  @lang('Recommendation')</h4>
                    </a>
                </h5>
            </div>
            <div id="recomendation" class="collapse" role="tabpanel" aria-labelledby="headingOne1">
                <div class="card-body">
