                        ...
                        <div class="row p-t-20">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="occupational_disease" id="occupational_disease" class="form-control" disabled>
                                </div>
                            </div>
                        </div>
                        {{-- <div class="row p-t-20">
...
$('.customRadio').on('change' , function () {
    ...
    var employment_injury = document.getElementById("occupational_disease");
    ...
    {
        occupational_disease.value = "Yes";
    }
    else
    {
        occupational_disease.value = "No";
    }
