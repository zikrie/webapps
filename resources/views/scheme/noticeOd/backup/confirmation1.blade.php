        ...
        <div class="col-12">
            <div class="card">
                ...
                <form action="confirmationilat" method="POST">  
                 <h5 class="card-title">@lang('scheme/confirmation.title')</h5>
                    <hr>  
                   ...
                   <div class="form-group">
                    ...
                    <small class="form-control-feedback"> If there is a change of office </small> </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="customCheck1">@lang('scheme/confirmation.attr.bank_completed') &nbsp; &nbsp; </label>   <input type="checkbox" class="custom-control-input" id="customCheck1">
                                        </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">@lang('scheme/confirmation.attr.completion_completed')</label>
                        ...
                        {{-- <div class="row">
                            ...
                            <div class="form-actions">
                               ...
                               <!--a href='/preview' class="btn btn-secondary" >Preview</a-->
                                <button type="submit" name="action" value="Submit" class="btn waves-effect waves-light btn-primary" id="submit" onclick="return confirm('Are you sure want to submit?');">@lang('confirmation.submit')</button>
                                <a href="/ilatpreview" id='preview' type="button" name="action" value="Preview" class="btn btn-secondary">@lang('confirmation.preview')</a>
                            
                                @else
                            
                                <!--button type="button" name="action" value="Preview" class="btn btn-secondary" disabled>@lang('confirmation.preview')</button-->
                                <button type="submit" name="action" value="Submit" class="btn waves-effect waves-light btn-primary" id="submit" disabled>@lang('confirmation.submit')</button>
                                <a href="/ilatpreview" id='preview' type="button" name="action" value="Preview" class="btn btn-secondary">@lang('confirmation.preview')</a>
