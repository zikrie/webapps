    ...
    <div class="col-12">
     <div class="card-body">
            ...
            <div class="form-body">
                ...
                <div class="row p-t-20">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control">
                                {{-- <option>@lang('socso.attr.select_city')</option> --}}
                    ...
                    <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <select class="form-control">
                            {{-- <option>@lang('socso.attr.select_state')</option> --}}
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <small class="form-control-feedback">@lang('socso.attr.details')</small> </div>
                </div>
                <div class="col-md-6">
                 <div class="form-group">
        ...
        <div class="form-actions">
            <button type="button" class="btn btn waves-effect waves-light btn-secondary">@lang('socso.cancel')</button>
            <button type="button" class="btn btn waves-effect waves-light btn-secondary">@lang('socso.clear')</button>
            <button type="submit" class="btn btn waves-effect waves-light btn-success"> <i class="fa fa-check"></i>
            @lang('socso.save')</button>
        </div>
    </form>
</div>
</div>
