                                        ...
                                        <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="attendwork">
                                            <div class="card-body">
                                             <div class='row'>       
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="control-label" >@lang('scheme.medicalDetails.attr.start_mc')</label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="control-label" >@lang('scheme.medicalDetails.attr.end_mc')</label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label class="control-label">@lang('scheme.medicalDetails.attr.total_days')</label>
    ...
    <script>
        ...
        function datafield() {
            ...
            total_days1.setAttribute("id","days1"+room);
					...
					divtest.innerHTML = '<div class="col-lg-12"><form action="#"><div class="form-body"><hr><div class="row p-t-20"><div class="col-md-12"><div class="form-group"><label class="control-label">@lang('scheme/medicalDetails.attr.nameAddress_clinic')</label><textarea type="text" id="name" class="form-control"></textarea></div></div><div class="col-md-3"><div class="form-group"><label class="control-label">@lang('scheme/medicalDetails.attr.start_mc')</label><input  id="startdate" type="text" class="datepicker" placeholder="dd/mm/yyyy"></div></div><div class="col-md-3"><div class="form-group"><label class="control-label" >@lang('scheme/medicalDetails.attr.end_mc')</label><input id="enddate" type="text" class="datepicker" placeholder="dd/mm/yyyy"></div></div><div class="col-md-3"><div class="form-group"><label class="control-label" >@lang('scheme/medicalDetails.attr.total_days')</label><input type="text" id="days" class="form-control" placeholder=""></div></div><div class="col-md-3"><div class="form-group"><label class="control-label">@lang('scheme/medicalDetails.attr.mc_status')</label><select class="form-control"><option value=""></option><option value=""></option></select></div></div><div class="col-md-3"><div class="form-group"><label class="control-label" >@lang('scheme/medicalDetails.attr.start_date')</label><input id="startdate1" type="text" class="datepicker" placeholder="dd/mm/yyyy"></div></div><div class="col-md-3"><div class="form-group"><label class="control-label" >@lang('scheme/medicalDetails.attr.end_date')</label><input id="enddate1" type="text" class="datepicker" placeholder="dd/mm/yyyy"></div></div><div class="col-md-3"><div class="form-group"><label class="control-label">@lang('scheme/medicalDetails.attr.days_work')</label><input type="text" id="days1" class="form-control" placeholder=""></div></div><div class="col-md-3"><div class="form-group"><label class="control-label">@lang('scheme/medicalDetails.attr.status')</label><input type="text" id="status" class="form-control" placeholder=""></div></div></div></div><div class="row"><div class="col-md-4"><div class="form-group"><label class="control-label">@lang('scheme/medicalDetails.attr.wages_mc')</label><select class="form-control custom-select"><option>@lang('scheme/medicalDetails.attr.yes')</option><option>@lang('scheme/medicalDetails.attr.no')</option></select></div></div></div><div id="id1"></div></form></div></div></div>'; 
