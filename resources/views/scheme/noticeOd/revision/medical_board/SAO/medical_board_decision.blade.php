                ...
                <form action="/caseinfo_revision" method="POST">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row p-t-20">
                            <div class="col-md-6">
                                <div class="form-group">
                                   <label class="control-label">{{--@lang('insuredPerson.attr.notice')--}}Invalidity Starting Date Requirements</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                   <label class="control-label">{{--@lang('insuredPerson.attr.notice')--}}Morbidity Date Requirements</label>
                        ...
                        <div class='row'>
                            <div class="col-md-6">
                                <div class="form-group">
                                <label class="control-label">{{--@lang('insuredPerson.attr.reasonOfApplication')--}}Age at the Time of Invalidity Starting Date</label>
                                <input type="text" id="ageinvalidity_medical" readonly name="ageinvalidity" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                <label class="control-label">{{--@lang('insuredPerson.attr.reasonOfApplication')--}}Age at the Time of Morbid Date</label>
                                <input type="text" id="agemorbid_medical" readonly name="agemorbid" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class='row'>
                        ...
                        <div class='row'>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" id="morbiddate_medical" readonly name="morbiddate" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
