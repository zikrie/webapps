                        ...
                        <div class="row p-t-20">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="noticeID_els_pk" name="notice_pk" value="" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class='row'>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="revType_els_pk" name="rev_type_pk" value="" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class='row'>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="dateRevNotice_els_pk" name="dateRevNotice_pk" value=""
                                        class="form-control">
                                </div>
                            </div>
                        </div>
