                        ...
                        <div class="row p-t-20">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly id="noticeID_els" name="notice" value="" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class='row'>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly id="revType_els" name="rev_type" value="" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class='row'>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" readonly id="dateRevNotice_els" name="dateRevNotice" value=""
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
