                ...
                <form action="/caseinfo_revision" method="POST">
                    ...
                    <div class="form-body">
                        ...
                        <div id="accordion22" role="tablist" class="accordion" >
                            ...
                            <!-- claim case info-->
                            <div class="card m-b-0">
                                <div class="card-header" role="tab" id="medical3">
                                    <h5 class="mb-0">                           
                                        <a class="link" data-toggle="collapse" data-parent="#accordion22" href="#medicalcol3" aria-expanded="false" aria-controls="medicalcol3"><h5 class="card-title"><i class="fa fa-plus"></i>
                                        ILAT</h5>
                                        </a>
                                    </h5>
                                </div>
                                <div id="medicalcol3" class="collapse" role="tabpanel" aria-labelledby="medical3">
                                    <div class="card-body">
                                        <div class="row p-t-20">
                                            <div class="col-md-4">
                                                <div class="form-group">
