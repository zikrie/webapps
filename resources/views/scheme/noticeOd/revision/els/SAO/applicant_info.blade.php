                        ...
                        <div class='row'>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select readonly class="form-control clearfields" name='idtype' id='idtype' required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" id="idNum_els" name="idNum" value="" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class='row'>
