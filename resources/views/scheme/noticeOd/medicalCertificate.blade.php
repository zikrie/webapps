  ...
  <div class="card-body">
    <form method="post" action="{{ url('/updmc') }}">
      ...
      <br/>
                  ...
                  <div class="card-body">
                    <div class='row'>       
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            <label class="control-label">@lang('scheme/medicalDetails.attr.type_hus')</label>
                          ...
                          <div class="card m-b-0">
                            <div class="card-header" role="tab" id="attendwork">
                              <h6 class="card-subtitle">
                                <a class="collapsed link" data-toggle="collapse" data-parent="#work_accordion{{ $key }}" href="#work_collapse{{ $key }}" aria-expanded="false" aria-controls="collapseTwo3">
                                  >  @lang('scheme/medicalDetails.attr.attended_work')
                                </a>
                              </h6>
                            </div>
                            <div id="work_collapse{{ $key }}" class="collapse" role="tabpanel" aria-labelledby="attendwork">
                              <div class="card-body">
                                  ...
                                  <table id="attended_work_tbl{{ $key }}" class="table table-sm table-bordered" data-toggle-column="first">
                                    <thead>
                                      <tr>
                                        ...
                                        <th style='width:50%'>@lang('scheme/medicalDetails.attr.status')</th>
                                        <th style='width:50%'>@lang('scheme/medicalDetails.attr.action')</th>
                                      </tr>
                                    </thead>
                                    <tbody>
                                ...
                                <div class="row">
                                  <button type="button" id="btn_add_workmc{{ $key }}" class="btn btn-sm waves-effect waves-light btn-success btn_add_workmc">@lang('scheme/medicalDetails.addwork')</button>
                                </div>
                              </div>
                            </div>
                          </div>
        ...
        @include('Scheme.noticeAccident.medicalCertificate_add')
        @endif
      ...
      <div class="form-actions text-right">
        ...
        @lang('insuredPerson.save')</button>
          <button type="button" id="btn_add_mc" class="btn btn-sm waves-effect waves-light btn-info">@lang('scheme/medicalDetails.addmc')</button>
...
$(document).ready(function() {
  ...
  function counttotal(mcid){
    ...
    if(days > 1){
      lblmcerror.innerHTML = 'MC start date cannot exceed the current date';
      btnsubmit.disabled = true;
      total.value = '';
      return;
    }else{
