<div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                 <form action="#">
                    <h5 class="card-title">@lang('scheme/fhusPayment.title')</h5>
                    <hr>
                        <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('scheme/husPayment.attr.mc_end')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('scheme/fhusPayment.attr.total_day')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('scheme/fhusPayment.attr.total_HUS')</label>
                       ...
                       <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('scheme/fhusPayment.attr.remark')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                   <label class="control-label">@lang('scheme/fhusPayment.attr.status')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('scheme/fhusPayment.attr.assumed_wage')</label>
                       ...
                       <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('scheme/fhusPayment.attr.total_assumed')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                   <label class="control-label">@lang('scheme/fhusPayment.attr.assumed_average_monthly')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">@lang('scheme/fhusPayment.attr.assumed_average_daily')</label>
                        ...
                        <div class="row p-t-20">
                             <div class="col-md-4">
                                 <div class="form-group">
                                     <label class="control-label">@lang('scheme/fhusPayment.attr.fhus_daily_rate')</label>
                             ...
                             <div class="col-md-4">
                                 <div class="form-group">
                                    <label class="control-label">@lang('scheme/fhusPayment.attr.minimum_daily_rate')</label>
                             ...
                             <div class="col-md-4">
                                 <div class="form-group">
                                     <label class="control-label">@lang('scheme/fhusPayment.attr.maximum_daily_rate')</label>
                         ...
                         <div class="row p-t-20">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">@lang('scheme/fhusPayment.attr.total_HUS_days')</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                       <label class="control-label">@lang('scheme/fhusPayment.attr.total_FHUS_payment')</label>
