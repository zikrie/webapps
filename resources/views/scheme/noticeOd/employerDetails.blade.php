                        ...
                        <div class="row p-t-20">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" tabindex="1" name='emptype' id='emptype' required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" name="email" value="{{$emprecord->email}}" class="form-control">
                                    @elseif(!empty($employer) && $employer->faxno != '')
                                    <input type="email" id="email" name="email" value="{{$employer->email}}" class="form-control">
                                    @else
